package Hieu_iceTea.TicTacToe_V2;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Welcome TicTocToe - Hiếu iceTea - Toast", Toast.LENGTH_LONG).show();
        Snackbar.make(gridLayout, "Welcome TicTocToe - Hiếu iceTea - Snack bar", Snackbar.LENGTH_LONG).show();
